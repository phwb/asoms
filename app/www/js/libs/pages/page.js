...
define([
    ...
    var hiddenToolbar = {}, currentPageID = ''; // айдишник страницы
    /**
     * @param {object} params
    ...
    Page.prototype.add = function (params, callback) {
        ...
        // айди текущей страницы
        currentPageID = page.data('page');
        // событие перед добавлением страницы
        Backbone.Events.trigger('page:beforeAdd', currentPageID);
    ...
    // static function
    Page.prototype.getCurrentPageId = function () {
